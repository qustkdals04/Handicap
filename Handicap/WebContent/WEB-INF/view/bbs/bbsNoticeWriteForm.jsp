...
<body>
	...
	<table class="bbsTitle">
		...
		<tr>
				...
				<td width="600px"> ${bbsNoticeUpdateForm.author }</td>
			</tr>
			...
			<tr>
				...
				<button type="button" id="bbsNoticelist" onclick="location.href='/Handicap/bbsList?boardno=${bbsNoticeUpdate.boardno}'">목록</button>
				</td>
			</tr>
		</table>
