...
<body>
	<form id="bbsNoticeContent" name="bbsNoticeContent">
		<table class="bbsTitle">
			<tr>
				<td align="left"><font size="50">상세보기</font></td>
			</tr>
		</table>
			...
			<td width="50px"><font size="3px"
				...
				<td width="350px" align="left"><font size="3px"
					style="font-weight: bold;">
						${bbsNoticeContent.title}</font></td>
				<td colspan="2" width="300px" align="right"><font size="2px">작성일
						: ${bbsNoticeContent.writedate}</font></td>
			</tr>
			<tr>
				<td colspan="4" align="left"><font size="3px">작성자 : ${bbsNoticeContent.author}
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          조회수 : ${bbsNoticeContent.hits}</font></td>
			</tr>
			<tr>
		...
		<table class="bbsList">
			<tr>
				<td align="left" width="400px"><button type="button" id="list"
