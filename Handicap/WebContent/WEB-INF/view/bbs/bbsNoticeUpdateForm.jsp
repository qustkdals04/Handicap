										...
										<c:when test="${boardno == '30'}">
											<table class="bbsList">
												...
												<tr>
													...
													<td width="700px"><textarea name="contents"
															id="contents" rows="13" cols="40"
															...
															<table class="bbsList">
																...
																<c:otherwise>
																	<table class="bbsList">
																		<tr>
																			<td align="center" width="100px"
																				style="width: 117px;"><font size="3px">작성자</font></td>
																		...
																		<tr>
																			...
																			<td align="left">
																				<table id="fileview" align="left">
																					...
																					<tr>
																						<td colspan="2"><input name="files"
																							type="file" /> <input id="addFile" type="button"
																							value="파일첨부" /></td>
																						<td><c:forEach var="bbsFileName"
																								items="${bbsFileName}">
																								<tr>
																	...
																	<input type="hidden" name="boardno" id="boardno"
																		value="${bbsNoticeUpdateForm.boardno }">
																	<input type="hidden" name="no"
																		value="${bbsNoticeUpdateForm.no }">
																	</form>
							</td>
						</tr>
					</table>
