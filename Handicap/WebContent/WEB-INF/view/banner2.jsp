...
<body>
	<div id="testbanner" >
        <table >
       	<tr>
       		<!-- 발달 장애인 지원센터 -->
       		<td><a href="http://www.broso.or.kr/"> <img src="img/cc .png"  ></a></td>
       	...
       	<tr>
       		<!-- 인청전략기금 운영사무국 -->
       		<td><a href="http://mrr.koddi.or.kr/page/index_kor.jsp"> <img src="img/charter.jpg"  ></a></td>
       	</tr>
       </table>
 <div style="cursor:pointer;" onclick="window.scrollTo(0,0);"><img src="img/top.JPG"></div>
  </div>  
<!--  <ul>
