...
<body>
	<center>
		<form name="messageWrite" id="messageWrite">
			...
			<table class="list3">
				<tr>
					<th align="left" width="500px" colspan="4">받는사람 입력&nbsp;&nbsp;<input
						type="text" name="recipient" id="recipient"
						style="width: 181px; height: 22px;"> <img
						src="/Handicap/img/search.png" id="findnick" width="70px"
						style="vertical-align: middle;"> <!-- <button id="findnick">검색</button> --></th>



					<th width="300px" align="center"></th>
				</tr>
				<tr>

					<td colspan="5"><textarea rows="10" cols="50" name="contents"
							id="contents" style="width: 100%; height: 200px;"></textarea></td>
				</tr>
				<tr>
